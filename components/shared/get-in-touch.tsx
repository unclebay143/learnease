...
const GetInTouch = () => {
  return (
    <section className='max-w-screen-sm px-6 mx-auto my-20 text-center'>
      <h3 className='text-4xl font-medium leading-10 text-center text-gray-900'>
        Have any
      ...
      <p className='my-6 text-gray-600 sm:text-lg text-center'>
